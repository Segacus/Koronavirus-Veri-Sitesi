...
<html>
  <head>
    ...
    <title>Korona Günlük Veri</title>
    ...
    <div class="wrapper">
      <div class="panel">
        <div class="panel-header">
          <h3 class="title">Korona Günlük Veri Tablosu</h3>
        ...
        <div class="panel-body">
          <div class="categories">
            <div class="category">
              ...
              <span><?php echo ''.$covidUrlJsonParse['testsPerOneMillion']." 
   ";?></span>
            </div>
            <div class="category">
              <span>Vaka Sayısı</span>
              <span><?php echo ''.$covidUrlJsonParse['todayCases']." 
   ";?></span>
            </div>

                        
                        <div class="category">
              <span>Kritik Hasta Sayısı</span>
              <span><?php echo ''.$covidUrlJsonParse['critical']." 
   ";?></span>
            </div>
                        <div class="category">
              <span>Vefat Eden Hasta Sayısı</span>
              <span><?php echo ''.$covidUrlJsonParse['todayDeaths']." 
   ";?></span>
            </div>
            <div class="category">
              <span>İyileşen Hasta Sayısı</span>
              <span><?php echo ''.$covidUrlJsonParse['todayRecovered']." 
   ";?></span>
            </div>
          </div>
          ...
          <div class="chart">
            ...
            <div class="android-stats">
              <?php echo ''.$covidUrlJsonParse['todayDeaths']." 
   ";?><span></span>
            </div>
            <div class="ios-stats">
              <span></span><?php echo ''.$covidUrlJsonParse['testsPerOneMillion']." 
   ";?>
            </div>
            <div class="windows-stats">
              <span></span><?php echo ''.$covidUrlJsonParse['todayCases']." 
   ";?>
            </div>
